...
- [x] Double check after each step/modification how the data looks like by visualizing, printing or showing first results in the table format.

### **3.2: Preprocessing**

- [ ] (DEPRECATED) Encode binary categorical variables (e.g., `gender`) with `LabelEncoder`.
